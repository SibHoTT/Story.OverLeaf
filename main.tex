%% Зависимые файлы (со значком цепи) редактированию, видимо, не подлежат.
%% Пока не знаю лучшего, используется код шаблона для диссертаций на русском с
...
\input{puzzles/trinity}
\include{puzzles/witsnotproofs}
\include{puzzles/algorithmic}
...
%% TODO: чтобы генерация запускалась и работала разбивка по тематикам
